    ...
    def Statusfail(self):
        if logined:
            ...
            if LANG=="cn":
                ...
                import language.en as lang
            if err_message=="301":
                errormessage=lang.error_301.decode("utf-8")
            elif err_message=="302":
                errormessage=lang.error_302.decode("utf-8")
            elif err_message=="303":
                errormessage=lang.error_303.decode("utf-8")
            else:
                errormessage=""
