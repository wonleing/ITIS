...
drop table project;
create table project (pjname varchar(20) primary key, code varchar(20), description varchar(20), people varchar(40), ctime varchar(20), comments varchar(20));
...
insert into project values ("itis", "itis", "Initial sample project", "Leon, Nie", "2009-07-29-16:25:17", "Company project");
