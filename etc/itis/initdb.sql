...
drop table project;
create table project (pjname varchar(20), code varchar(20) primary key, description varchar(40), people varchar(40), ctime varchar(20));
...
insert into project values ("itis", "itis", "Initial sample project", "leon itis", "2009-07-29");
